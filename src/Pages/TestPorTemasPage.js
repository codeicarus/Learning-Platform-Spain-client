...
class TestPorTemasPage extends Component {
  state = {
  ...
  async getAreasWTemas() {
    axios
      .get(process.env.REACT_APP_URL_API + `areasWTemas`, {
        headers: {
          authorization: localStorage.getItem("token_penitenciarios"),
        },
      })
  ...
  changeTemasSelected = (id_tema, estado) => {
    if (estado) {
      let actual_selected = this.state.temas_selected;
      actual_selected.push(id_tema);
      this.setState({
        temas_selected: actual_selected,
      });
    } else {
      let new_selected = [];
      let actual_selected = this.state.temas_selected;
  ...
  async createTest() {
    if (this.state.temas_selected.length > 0) {
      axios
        .post(
          process.env.REACT_APP_URL_API + `preguntas`,
          {
            tipo: "Test por temas",
            temas: this.state.temas_selected,
      ...
      toast.error("Tienes que seleccionar al menos un tema");
    }
  }
            ...
            <div className="container">
              <div className="row intro mt-5 mt-sm-2">
                <div className="col-12">
                  <h2 className="featured">Test por temas</h2>
                  <p>Selecciona los temas de los que quieres hacer el test</p>
                </div>
              </div>
              {new Date().getTime() / 1000 >=
                ...
                <div className="mensaje_capado">
                  <p>
                    Solo puedes hacer examenes de test por temas del tema 5 de
                    Derecho Penitenciario hasta que no estes suscrito
                  </p>
              ...
              <div className="row justify-content-center text-center items">
                {this.state.areasWTemas?.map((area, i) => {
                  return area.temas.length > 10 ? (
                    <div key={i} className="row text-center items lis_al_50">
                      <AreaWTemasSection
              ...
              <div className="row intro mt-4 mt-sm-4 mb-sm-4">
                <div className="col-12">
              ...
              <div className="row justify-content-center text-center">
                ...
                {new Date().getTime() / 1000 >=
                  localStorage.getItem("penitenciarios_mds") && (
                  <div
                    title="Para poder hacer test de 40 preguntas tienes que suscribirte"
                    className="col-6 col-md-3 col-lg-2 align-self-auto item"
                  >
                    <div>
                      <ul className="list-group list-group-flush">
                ...
                {new Date().getTime() / 1000 >=
                  localStorage.getItem("penitenciarios_mds") && (
                  <div
                    title="Para poder hacer test de 60 preguntas tienes que suscribirte"
                    className="col-6 col-md-3 col-lg-2 align-self-auto item"
                  >
                    <div>
                      <ul className="list-group list-group-flush">
                  ...
                  <div className="col-6 col-md-3 col-lg-2 align-self-auto item">
                    <div>
                      <ul className="list-group list-group-flush">
                        <li
                          onClick={() =>
                            this.changeSelectedNumeroPreguntas(100)
                          }
                          className="list-group-item text-left"
                        >
                ...
                {new Date().getTime() / 1000 >=
                  localStorage.getItem("penitenciarios_mds") && (
                  <div
                    title="Para poder hacer test de 100 preguntas tienes que suscribirte"
                    className="col-6 col-md-3 col-lg-2 align-self-auto item"
                  >
                    <div>
                      <ul className="list-group list-group-flush">
                  ...
                  <div className="col-6 col-md-3 col-lg-2 align-self-auto item">
                    <div>
                      <ul className="list-group list-group-flush">
                        <li
                          onClick={() =>
                            this.changeSelectedNumeroPreguntas(150)
                          }
                          className="list-group-item text-left"
                        >
                ...
                {new Date().getTime() / 1000 >=
                  localStorage.getItem("penitenciarios_mds") && (
                  <div
                    title="Para poder hacer test de 150 preguntas tienes que suscribirte"
                    className="col-6 col-md-3 col-lg-2 align-self-auto item"
                  >
                    <div>
                      <ul className="list-group list-group-flush">
...
export default TestPorTemasPage;
